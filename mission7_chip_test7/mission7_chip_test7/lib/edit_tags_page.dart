...
import 'package:mission7chiptest7/src/substring_highlight.dart';
import 'package:flutter/cupertino.dart';
import 'package:autocomplete_textfield/autocomplete_textfield.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:mission7chiptest7/src/chip_data.dart';
...
class _ChipsEditState extends State<ChipsEdit> {
  ...
  //占位符尝试
  String replacement = "输入标签";
  bool _hashintText = false;
              ...
              onChanged: (text) {
                setState(() {
                  ...
                  _textFieldController.text.length != 0 ?  Overlay.of(context).insert(overlayEntry)
                                                        :  overlayEntry.remove();
                  _hashintText = (_textFieldController.text.isNotEmpty);
                });

                if(_textFieldController.text.length < text.length && !_hashintText ){
                  widget.inputs.removeLast();
                }

//                if(textEdit.length == replacement.length){
//                  widget.inputs.removeLast();
//                }
              },
